...
joinedLuxList = cat(1,LuxList1Num, LuxListNum);
            ...
            query2a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND health = 'N/A' AND feeder = '1' AND lightlevel = '1';";
            res2a = fetch(conn,query2a);

            query2b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND health = 'N/A' AND feeder = '2' AND lightlevel = '1';";
            res2b = fetch(conn,query2b);
            
            query2c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND health = 'N/A' AND feeder = '3' AND lightlevel = '1';";
            res2c = fetch(conn,query2c);

            query2d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND health = 'N/A' AND feeder = '4' AND lightlevel = '1';";
        ...
        for k = 1:l2
            query1a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND intensityofcost3 = '" + LuxList(k) + "' AND health = 'N/A' AND feeder = '1' AND lightlevel = '1';";
            res1a = fetch(conn,query1a);

            query1b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND intensityofcost3 = '" + LuxList(k) + "' AND health = 'N/A' AND feeder = '2' AND lightlevel = '1';";
            res1b = fetch(conn,query1b);
            
            query1c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND intensityofcost3 = '" + LuxList(k) + "' AND health = 'N/A' AND feeder = '3' AND lightlevel = '1';";
            res1c = fetch(conn,query1c);

            query1d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND intensityofcost3 = '" + LuxList(k) + "' AND health = 'N/A' AND feeder = '4' AND lightlevel = '1';";
