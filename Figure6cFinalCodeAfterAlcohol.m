...
MaleAnimalList = {'aladdin', 'carl', 'jafar', 'jimi', 'jr', 'kobe', 'mike', 'scar', 'simba', 'sully'};
n1 = length(MaleAnimalList);

FemaleAnimalList = {'alexis', 'fiona', 'harley', 'juana', 'kryssia', 'neftali', 'raven', 'renata', 'sarah', 'shakira'};
n2 = length(FemaleAnimalList);
LuxList = unique(results.intensityofcost3);
...
joinedLuxList = cat(1,LuxList1Num, LuxListNum);
            ...
            query2a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023' AND feeder = '1' AND lightlevel = '1' AND gender = 'Male';";
            res2a = fetch(conn,query2a);

            query2b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '2' AND lightlevel = '1' AND gender = 'Male';";
            res2b = fetch(conn,query2b);
            
            query2c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '3' AND lightlevel = '1' AND gender = 'Male';";
            res2c = fetch(conn,query2c);

            query2d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '4' AND lightlevel = '1' AND gender = 'Male';";
            res2d = fetch(conn,query2d);
        ...
        for i = 1:n1
            query1a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + MaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '1' AND lightlevel = '1';";
            res1a = fetch(conn,query1a);

            query1b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + MaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '2' AND lightlevel = '1';";
            res1b = fetch(conn,query1b);
            
            query1c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + MaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '3' AND lightlevel = '1';";
            res1c = fetch(conn,query1c);

            query1d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + MaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '4' AND lightlevel = '1';";
            res1d = fetch(conn,query1d);
...
err(1) = std(MaleEntry1, 'omitnan')/sqrt(10);
err(2) = std(MaleEntry2, 'omitnan')/sqrt(10);
err(3) = std(MaleEntry3, 'omitnan')/sqrt(10);
err(4) = std(MaleEntry4, 'omitnan')/sqrt(10);


        errorbar(Reward, MaleEntry, err, '-o');
        hold on
            query2a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023' AND feeder = '1' AND lightlevel = '1' AND gender = 'Female';";
            res2a = fetch(conn,query2a);

            query2b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '2' AND lightlevel = '1' AND gender = 'Female';";
            res2b = fetch(conn,query2b);
            
            query2c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '3' AND lightlevel = '1' AND gender = 'Female';";
            res2c = fetch(conn,query2c);

            query2d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '4' AND lightlevel = '1' AND gender = 'Female';";
            res2d = fetch(conn,query2d);
        ...
        for i = 1:n2
            query1a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + FemaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '1' AND lightlevel = '1';";
            res1a = fetch(conn,query1a);

            query1b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + FemaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '2' AND lightlevel = '1';";
            res1b = fetch(conn,query1b);
            
            query1c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + FemaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '3' AND lightlevel = '1';";
            res1c = fetch(conn,query1c);

            query1d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + FemaleAnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND genotype = 'lg_etoh' OR genotype = 'lg_boost' AND date >= '02/09/2023' AND date <= '02/23/2023'  AND feeder = '4' AND lightlevel = '1';";
            res1d = fetch(conn,query1d);
...
err(1) = std(FemaleEntry1, 'omitnan')/sqrt(10);
err(2) = std(FemaleEntry2, 'omitnan')/sqrt(10);
err(3) = std(FemaleEntry3, 'omitnan')/sqrt(10);
err(4) = std(FemaleEntry4, 'omitnan')/sqrt(10);

% femtab = table(transpose(FemaleAnimalList),transpose(FemaleEntry1),transpose(FemaleEntry2),transpose(FemaleEntry3),transpose(FemaleEntry4));
% maletab = table(transpose(MaleAnimalList),transpose(MaleEntry1),transpose(MaleEntry2),transpose(MaleEntry3),transpose(MaleEntry4));
        errorbar(Reward, FemaleEntry, err, '-o');
        legend('Normal Male', 'Normal Female','Alcohol Male', ' Alcohol Female');
        xlabel("Reward Level");
        ylabel("Percent Change in Acceptance Rate over Cost");
        title("After Alcohol Cost Effect on Approach Rate Over Reward")

%         filename = "AlcPlots2/AfterAlcoholBoostandEtohMaleFemaleCostEffectonReward.fig";
%         saveas(gcf, filename);
