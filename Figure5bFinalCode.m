...
joinedLuxList = cat(1,LuxList1Num, LuxListNum);
        ...
        for i = 1:n
            query1a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '1' AND lightlevel = '1' AND gender = 'Male';";
            res1a = fetch(conn,query1a);

            query1b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '2' AND lightlevel = '1' AND gender = 'Male';";
            res1b = fetch(conn,query1b);
            
            query1c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '3' AND lightlevel = '1' AND gender = 'Male';";
            res1c = fetch(conn,query1c);

            query1d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '4' AND lightlevel = '1'  AND gender = 'Male';";
...
Reward(4) = 9;
        ...
        for i = 1:n
            query1a = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '1' AND lightlevel = '1' AND gender = 'Female';";
            res1a = fetch(conn,query1a);

            query1b = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '2' AND lightlevel = '1' AND gender = 'Female';";
            res1b = fetch(conn,query1b);
            
            query1c = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '3' AND lightlevel = '1' AND gender = 'Female';";
            res1c = fetch(conn,query1c);

            query1d = "SELECT approachavoid FROM live_table WHERE tasktypedone = 'P2 L1L3' AND subjectid = '" + AnimalList(i)+ "' AND intensityofcost3 = '" + LuxList(14) + "' AND health = 'Food Deprivation' AND feeder = '4' AND lightlevel = '1'  AND gender = 'Female';";
            res1d = fetch(conn,query1d);
...
err(4) = std(FemaleEntry4, 'omitnan')/sqrt(12);
        ...
        title("Food Deprivation Cost Effect on Approach Rate Over Reward")
% filename = "FoodDeprivMaleFemaleCostEffectPercentChangeinApproachRate.fig";
% saveas(gcf, filename);
hold off